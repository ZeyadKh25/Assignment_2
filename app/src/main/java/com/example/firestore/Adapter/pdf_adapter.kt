...
import com.example.firestore.MainActivity.Companion.storageRef
import com.example.firestore.databinding.DesignListBinding
...
class pdf_adapter(var activity: Activity, var data: ArrayList<pdf>) : BaseAdapter() {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        MainActivity.ref.downloadUrl.addOnSuccessListener {
            uriFrom = it.toString()
            Log.e("zzzzzzzzzzzzzzzzzzzzxxxxxxx", it.toString())
...
//            Toast.makeText(activity, "Failed", Toast.LENGTH_SHORT).show()
        ...
        if (data.size % 2 != 0) {
            binding.cardView2.setCardBackgroundColor(Color.CYAN)
        }
